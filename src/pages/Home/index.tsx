    ...
    <div className="home-page">
      <div className="container">
        <section className="h-[590px] flex flex-col md:flex-row items-center justify-between mb-28">
          <div className="max-w-[519px] w-full p-[16px] md:p-0">
            <p className="text-[38px] md:text-[3rem] mb-8 text-center md:text-left">Explore, collect, and sell extraordinary NFTs</p>
            <Button className="w-full md:w-fill px-12 py-3 text-lg h-auto" color="primary">Explore NFTs</Button>
          </div>
          <div className="cards relative left-[-80px] md:left-[-309px]">
              ...
              <Link to="/collections">
                ...
                >
                  <div className="card-details px-[15px] md:px-8 pt-1 md:pt-4 pb-6">
                    <p className="text-[11px] md:text-2xl mb-2">Collection name could be so long and a little bit longer</p>
            ...
            <div className="absolute -top-8 -right-[100px] md:-right-[216px]">
              <Card
                ...
                className="w-card-xs md:w-card-md"
              >
