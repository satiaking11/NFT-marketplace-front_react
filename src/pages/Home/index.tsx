  ...
  return (
    <div className="home-page p-[16px] xl:p-0">
      <div className="container">
        <section className="h-[590px] md:h-[750px] lg:h-[590px] flex flex-col lg:flex-row items-center justify-between mb-28 md:mb-40 lg:mb-28 ">
          <div className="max-w-[519px] lg:max-w-[400px] xl:max-w-[519px] w-full ">
          ...
          <div className="cards relative x left-[-80px] md:left-[-160px] lg:left-[-309px]">
            <div className="relative z-40">
              <Link to="/collections">
                <Card
                  cover="/images/nft-cover/1.png"
                  avatar="/images/avatar/card.png"
                  className="w-card-sm md:w-card-lg lg:w-card-md"
                >
